...
The repository contains the supplementary material ([readme](https://github.com/acadTags/tag-data-cleaning/blob/master/readme%20supplementary%20files.pdf)) for the paper:
